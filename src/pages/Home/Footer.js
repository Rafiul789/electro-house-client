...
const Footer = () => {
    return (
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="">
              ...
              <p className="mb-4">
                <a href="#!" className="text-gray-100">Services</a>
              </p>
              <p className="mb-4">
                <a href="#!" className="text-gray-100">Privacy Policy</a>
              </p>
              <p className="mb-4">
                <a href="#!" className="text-gray-100">Licencing</a>
              </p>
              <p>
                <a href="#!" className="text-gray-100">Terms and Condition</a>
              </p>
            </div>
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <div className="text-center p-6 bg-gray-800">
          ...
          <Link to='/' className="text-gray-100 font-semibold">Electro House</Link>
        </div>
      </footer>  </>
