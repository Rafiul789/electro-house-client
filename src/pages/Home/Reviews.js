...
const Feedback = () => {
  ...
  useEffect( ()=>{
      fetch('https://tranquil-bayou-94751.herokuapp.com/review')
      .then(res => res.json())
...
<section className="mb-32 text-gray-800 text-center">
  ...
  <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
    <div className="mb-12 md:mb-0">
     ...
     Their parts is best in the world!You can buy!
      </p>
    ...
    <div className="mb-12 md:mb-0">
      <div className="flex justify-center mb-6">
        <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(2).jpg" className="rounded-full shadow-lg w-32" alt='' />
      </div>
      ...
      <p className="mb-4">
        ...
        </svg>They offer  high quality parts! 100% genuine products!
      </p>
      <ul className="flex justify-center mb-0">
        <li>
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" className="w-4 text-yellow-500"
    ...
    <div className="mb-0">
      ...
      <p className="mb-4">
        ...
        </svg>I have bought some of their products!Very Great products!
      </p>
      <ul className="flex justify-center mb-0">
        <li>
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" className="w-4 text-yellow-500"
